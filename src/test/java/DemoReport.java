...
public class DemoReport {
    ...
    public static void createCheckup(XWPFDocument doc, List<Map> list) {
        XWPFParagraph paragraph = doc.createParagraph();
        XWPFRun run = paragraph.createRun();
        run.setFontSize(14);
        run.setFontFamily("Microsoft YaHei");
    ...
    public static void createCheckupResultByTemplate_1(XWPFDocument doc, HashMap param) {
    ...
    @SneakyThrows
    public static void createCheckupResultByTemplate_2(XWPFDocument doc, Map param) {
        String place = MapUtil.getStr(param, "place");
    ...
    public static void main(String[] args) throws Exception {
        ...
        HashMap param = new HashMap() {{
            put("uuid", "01GWY35ZBXW01682HXM7N44DSB");
            ...
            put("tel", "13312345678");
            put("date", "2023/12/07");
            put("company", "北京市XXXX有限责任公司");
            put("goods", "新感恩敬老中级体检套餐");
        }};
        ...
        //生成体检结果
        createCheckupResultByTemplate_1(doc, param);

        param = new HashMap() {{
            put("place", "心电图室");
            put("doctor", "张悦");
            put("date", "2023-11-15");
            put("image", "https://gss0.baidu.com/7LsWdDW5_xN3otqbppnN2DJv/dodo_89/pic/item/9346e6cfe0f0331c0eb345e1.jpg");
            put("item", new ArrayList<>() {{
                add(new HashMap<>() {{
                    put("name", "心电图(十二导联)");
                    put("value", "【P波】：Ⅱ直立，avR倒置，P-R间期>0.12秒。#【QRS波】：无异常。#【ST段】：无异常。#【T波】：无异常。#【U波】：无异常");
                    put("unit", null);
                    put("standard", null);
                }});
            }});
        ...
        //生成体检结果
        createCheckupResultByTemplate_2(doc, param);

        try (FileOutputStream out = new FileOutputStream("E:/tmp/word2008.docx");) {
            doc.write(out);
